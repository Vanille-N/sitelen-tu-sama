...
#let card(edge: (:), hidden-text: none) = {
  ...
  if hidden-text != none {
    rect((-2.6,-2.35), (to:(), rel:(5mm,4mm)), fill: palette.dark.gray, stroke: none)
    content((-2.34,-2.08))[#mono(palette.standard.gray, size: 11pt)[#hidden-text]]
  }
  for c in ((0,0), (1.5,0), (0,1.5), (-1.5,0), (0,-1.5)) {
    circle(c, radius: specs.radius * 30%, fill: palette.standard.black, stroke: none)
  }
